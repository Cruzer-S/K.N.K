...
void analyze_hand(char num_in_rank[NUM_RANKS], char num_in_suit[NUM_SUITS],
				  bool *flush, bool *four, bool *three, int *straight, int *pairs);
void print_result(bool flush, bool four, bool three, int straight, int pairs);
...
int main(void)
{
	...
	for (;;) {
		...
		analyze_hand(num_in_rank, num_in_suit,
				&flush, &four, &three, &straight, &pairs);
		print_result(flush, four, three, straight, pairs);
	}
